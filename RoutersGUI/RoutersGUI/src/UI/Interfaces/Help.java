...
public class Help extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/add_router.png"))); // NOI18N
        jLabel1.setText("Añadir un nuevo router");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/find_paths.png"))); // NOI18N
        jLabel2.setText("    Calcular ruta entre dos routers");

        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("Costo = Ancho de Banda (referencia) /");

        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("Ancho de Banda (interfaz)");
        ...
        jLabel6.setText("# Si el costo < 1, se redondea a 1");

        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setText("# La referencia no es editable una vez puesta.");
