...
public class CancelWarning extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        eliminar.setColor(new java.awt.Color(204, 204, 204));
        eliminar.setColorClick(new java.awt.Color(51, 51, 51));
        eliminar.setColorOver(new java.awt.Color(102, 102, 102));
        ...
        cancelar.setColor(new java.awt.Color(204, 255, 204));
        cancelar.setColorClick(new java.awt.Color(51, 255, 204));
        cancelar.setColorOver(new java.awt.Color(102, 255, 204));
        ...
        jLabel2.setText("¿Estás seguro? No se guardarán los cambios.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CancelWarning.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new CancelWarning().setVisible(true);
        });
    }
