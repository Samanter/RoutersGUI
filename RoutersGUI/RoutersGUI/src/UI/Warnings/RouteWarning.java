...
public class RouteWarning extends javax.swing.JFrame {
    public RouteWarning() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("¿Estás seguro de eliminar la ruta?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RouteWarning.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new RouteWarning().setVisible(true);
        });
    }
